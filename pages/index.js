...
export default function Home() {
  ...
  return (<>
    {/* <h1 className="mt-2">{t('greeting')}</h1> */}
    {/* Masthead */}
    <header className="masthead bg-primary text-white text-center">
      {<div className="container d-flex align-items-center flex-column">
        ...
        {/* Masthead Subheading */}
        <h1 className="masthead-subheading font-weight-light mt-1">Software Engineer</h1>

        <p className="lead">Technologies used in this page</p>
        <ul>
          <li> React </li>
          <li> Bootstrap </li>
          <li> NextJS </li>
        ...
        {/* <p className="lead">Você pode acessar o código fonte de cada seção clicando no link ...</p>  */}
      </div>
      }
    </header>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 ms-auto">
            <p className="lead">Freelancer is a free bootstrap theme created by Anderson Carli. The download includes the
